...
static const EVP_CIPHER cipher_seed_192_ecb = {
    NID_seed_192_ecb,
    16, 24, 16,
    EVP_CIPH_ECB_MODE,
    seed_192_init_key,
...
static const EVP_CIPHER cipher_seed_256_ecb = {
    NID_seed_256_ecb,
    16, 32, 16,
    EVP_CIPH_ECB_MODE,
    seed_256_init_key,
...
static const EVP_CIPHER cipher_seed_192_cbc = {
    NID_seed_192_cbc,
    16, 24, 16,
    EVP_CIPH_CBC_MODE,
    seed_192_init_key,
...
static const EVP_CIPHER cipher_seed_256_cbc = {
    NID_seed_256_cbc,
    16, 32, 16,
    EVP_CIPH_CBC_MODE,
    seed_256_init_key,
...
static const EVP_CIPHER cipher_aria_ecb = {
    NID_aria_128_ecb,
    16, 16, 16,
    EVP_CIPH_ECB_MODE,
    aria_init_key,
...
static const EVP_CIPHER cipher_aria_192_ecb = {
    NID_aria_192_ecb,
    16, 24, 16,
    EVP_CIPH_ECB_MODE,
    aria_init_key,
...
static const EVP_CIPHER cipher_aria_256_ecb = {
    NID_aria_256_ecb,
    16, 32, 16,
    EVP_CIPH_ECB_MODE,
    aria_init_key,
...
static const EVP_CIPHER cipher_aria_cbc = {
    NID_aria_128_cbc,
    16, 16, 16,
    EVP_CIPH_CBC_MODE,
    aria_init_key,
...
static const EVP_CIPHER cipher_aria_192_cbc = {
    NID_aria_192_cbc,
    16, 24, 16,
    EVP_CIPH_CBC_MODE,
    aria_init_key,
...
static const EVP_CIPHER cipher_aria_256_cbc = {
    NID_aria_256_cbc,
    16, 32,16,
    EVP_CIPH_CBC_MODE,
    aria_init_key,
