...
static const char *engine_name = "Crypto rc4, rc4_40, des, 3des, aes, aria, seed | Digest sha1, sha256, sha512 engine for demonstration purposes";
...
static int ciphers_nids[] = { NID_rc4, NID_rc4_40,
                               ...
                               NID_aria_128_ecb, NID_aria_192_ecb, NID_aria_256_ecb,
                               NID_aria_128_cbc, NID_aria_192_cbc, NID_aria_256_cbc,
                               NID_seed_ecb, NID_seed_192_ecb, NID_seed_256_ecb,
                               NID_seed_cbc, NID_seed_192_cbc, NID_seed_256_cbc, 0 };
...
static int ciphers(ENGINE *e, const EVP_CIPHER **cipher, const int **nids, int nid)
{
    ...
    case NID_aria_128_cbc:
        *cipher = &cipher_aria_cbc;
        break;
    case NID_aria_192_cbc:
        *cipher = &cipher_aria_192_cbc;
        break;
    case NID_aria_256_cbc:
        *cipher = &cipher_aria_256_cbc;
        break;
    case NID_aria_128_ecb:
        *cipher = &cipher_aria_ecb;
        break;
    case NID_aria_192_ecb:
        *cipher = &cipher_aria_192_ecb;
        break;
    case NID_aria_256_ecb:
        *cipher = &cipher_aria_256_ecb;
        break;
	case NID_seed_ecb:
        *cipher = &cipher_seed_ecb;
        break;
    case NID_seed_192_ecb:
        *cipher = &cipher_seed_192_ecb;
        break;
    case NID_seed_256_ecb:
        *cipher = &cipher_seed_256_ecb;
        break;
    case NID_seed_cbc:
        *cipher = &cipher_seed_cbc;
        break;
    case NID_seed_192_cbc:
        *cipher = &cipher_seed_192_cbc;
        break;
    case NID_seed_256_cbc:
        *cipher = &cipher_seed_256_cbc;
        break;
    default:
        ok = 0;
        *cipher = NULL;
